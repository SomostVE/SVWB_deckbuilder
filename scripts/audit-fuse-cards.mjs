...
for (const c of hits) {
  console.log(JSON.stringify({id:c.id,name:c.name,class:c.class,type:c.type,cost:c.cost,keywords:c.keywords,traits:c.traits,text:c.text,relatedCards:c.relatedCards}));
}
