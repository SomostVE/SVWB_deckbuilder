...
assert.equal(version, "01.05.001", "Official mechanics audit fix must use version 01.05.001");
...
assert.match(decisionSummary, /battle-replay-inspector\.js\?v=01\.05\.000/, "Battle Sim must keep loading the unchanged Replay Inspector build");
...
console.log("Replay Inspector + class-aware Battle UI + official mechanics fix regression: OK");
