(() => {
  ...
  async function checkVersion() {
    ...
    try {
      const url = new URL("../version.json", document.currentScript?.src || document.baseURI);
    ...
    // This is intentionally the only localStorage key modified here.
    // Decks, collection, favorites and saved variants stay untouched.
  ...
  async function registerWorker(version) {
    ...
    try {
      const workerUrl = new URL("../sw.js", document.currentScript?.src || document.baseURI);
